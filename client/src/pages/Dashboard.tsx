...
export default function Dashboard() {
  ...
  const runDraw = async () => {
    ...
    try {
      ...
      // Sambungkan ke tahap validasi: isi kode pemenang otomatis biar panitia tinggal validasi.
      setScannedCode(revealedWinner.registrationCode);
      setScanNotice(`Pemenang: ${revealedWinner.name}. Kode sudah disiapkan untuk validasi hadiah.`);
